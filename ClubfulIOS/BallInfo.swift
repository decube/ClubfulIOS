...
class BallInfo{
    ...
    static func level(cols cols: Int, rows: Int){
        BallInfo.cols = cols
        BallInfo.rows = rows
        BallInfo.startBall()
    ...
    static func start(ctrl: UIViewController, view: UIView, scoreLbl: UILabel! = nil, timeLbl: UILabel! = nil){
        BallInfo.ctrl = ctrl
    ...
    static func gamePause(pause: Bool){
